// Simplex noise (2D/3D), adapted from Stefan Gustavson's public-domain
// implementation. Deterministically seeded so flow fields are reproducible.
...
export class SimplexNoise {
  constructor(seed = 1234) {
    ...
    // Deterministic LCG shuffle (no Math.random dependency for the table).
    let s = seed >>> 0;
    const rnd = () => {
